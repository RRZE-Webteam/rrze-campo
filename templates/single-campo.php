...
fau_breadcrumb();
    ?>
		...
		<div class="row" aria-hidden="true" role="presentation">
		    <div class="col-xs-12">
			<p class="presentationtitle"><?php _e('Campo', 'rrze-campo');?></p>
		    </div>
		</div>
	</div>
    </section>
	...
	<div id="content">
		<div class="content-container">
		    <div class="content-row">
			    <main>
				<h1 class="screen-reader-text"><?php _e('Campo', 'rrze-campo');?></h1>
...
?>
<nav class="rrze-campo navigation">
    <div class="nav-previous">
        <a href="<?php echo get_permalink(); ?>"><span class="meta-nav">&laquo;</span> <?php _e('Back to overview', 'rrze-campo');?></a>
    </div>
</nav>
