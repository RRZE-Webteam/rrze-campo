...
class CampoWidget extends \WP_Widget
{
    ...
    public function __construct($pluginFile, $settings)
    {
        ...
        parent::__construct(
            'campo_widget',
            __('Campo Widget', 'rrze-campo'),
            array('description' => __('Displays a lecture', 'rrze-campo'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        echo do_shortcode('[campo task="' . $instance['task'] . '" ' . $field . '=' . $instance['campoid'] . $atts . ']');
    ...
    {
        $aOptions = [
            'lectures-single' => __('Lecture', 'rrze-campo'),
        ];
    ...
    public function form($instance)
    {
        ...
        echo $this->getInputHTML('campoid', 'Campo ID', !empty($instance['campoid']) ? $instance['campoid'] : null);
        echo '<br \>&nbsp;';
    }
